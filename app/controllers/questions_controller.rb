...
# This class contains methods index, show, new
class QuestionsController < ApplicationController
  before_action :authenticate
  before_action :check_user_filled_teams
  before_action :set_question, only: %i[show edit update destroy upvote
                                        downvote same_user close]
  before_action :same_user, only: %i[edit update destroy close]
  ...
  def show
    unless @question.can_we_display?
